...
class ZeroConfig(_ZeroBase):
    ...
    def _donate_zero_relations(self):
        ...
        is still false. Core self-binds the private store adapter;
        this method does not import Core's private condition
        implementation or call ``set_condition_lookup``. There is no
        Zero-owned ``Content._conditions`` store.
        """
