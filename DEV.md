...
C1 [django-trusts#154](https://github.com/django-trusts/django-trusts/pull/154)
`b6eebc9273bf30048d410305a53249bdb51679f0`. The previous paired core
floor remains
...
Pair CI pins only merged Core
`b6eebc9273bf30048d410305a53249bdb51679f0`. The Zero suite (including
`tests/legacy/` historical copies from that core revision),
