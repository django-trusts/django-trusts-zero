"""Historical migration identity after the import-only rewrite."""
...
class HistoricalMigrationIdentityTests(TestCase):
    ...
    def test_makemigrations_trusts_check_is_quiet(self):
        ...
        try:
            ...
            self.fail('makemigrations trusts --check failed: %s' % exc)
